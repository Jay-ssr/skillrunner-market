...
[SugarTable("SplitTestTable_{year}{month}{day}")]  // 3个变量有，兼容开始按年，后面改成按月、按日
...
4. **【遇到优化】给获取表名方法加缓存**（用该功能升级5.1.4.140+不然可能会更新错表）
